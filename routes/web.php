...
Route::post('/register', [LoginController::class, 'register'])->name('authenticate_register');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::delete('/tweets/{tweet:id}', [TweetController::class, 'delete_tweet'])->name('tweet.delete');
