    ...
    <div class="col-1  col-md-1  col-lg-4 col-xl-4 px-0 nav-bar" style="min-width:50px;">
        <div
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-auto " id="menu">
                <li class="nav-item">
                    <a :href="route('home')" class="nav-link align-left">
                        <svg viewBox="0 0 24 24" aria-hidden="true" style="width: 18px"><g><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></g></svg>
                    </a>
                </li>
                <li class="nav-item">
...
<!--                </li>-->
                <li class="nav-item">
                    <Link :href="route('profile',user.handle)" :class="{ 'active-link': $page.url === '/'.concat(user.handle) }" class="nav-link  align-middle">
                        <i class="fs-6" :class="$page.url === '/'.concat(user.handle) ? 'bi-person-fill' : 'bi-person'"></i>
                        <span class="ms-2 d-none d-lg-inline" style="font-size:0.8rem;">Profile</span>
                    </Link>
                </li>
                <li class="nav-item">
