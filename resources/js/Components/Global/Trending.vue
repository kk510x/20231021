...
export default {
    ...
    methods: {
        ...
        searchTweets() {
            if (this.keyword !== '') {
                router.visit('/?keyword=' + this.keyword)
            }
        }
    },
    watch: {
    ...
    created() {
        axios.get('/trends').then((response) => {
            this.trendList = response.data.trendList;
        })
    }
}
</script>
        ...
        <div ref="last">
            <div class="sticky-top side-bar-top-container">
                <div class="side-bar-top" style="display:flex;">
                    ...
                    <input v-model="keyword" placeholder="Search" @keyup.enter.native="searchTweets"/>
                </div>
            </div>
            <div class="trending">
                ...
                <div class="trending-item" v-for="trend in trendList">
